...
namespace Курсовой_Проект
{
    public class Object3D
    {
        ...
        public Object3D(string objName, List<double[]> vertex, List<int[]> poly, List<int> submaterial, List<double[]> tVertex, List<int[]> tPoly, int material) {
            ObjName = objName;
            Vertex = vertex;
            Poly = poly;
            TVertex = tVertex;
        ...
        public Object3D(string objName, List<double[]> vertex, List<int[]> poly, List<int> submaterial, List<double[]> tVertex, List<int[]> tPoly, int material, double[] position)
        {
            ObjName = objName;
            Vertex = vertex;
            Poly = poly;
